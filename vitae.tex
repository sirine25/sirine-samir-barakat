...
\section{Summary}
Sirine has a strong background in teaching and supervision high and middle schools in both American and National systems. As well as preparing and dealing with the accreditation by Advanced teams in their visits to the American Schools in Alexandria.
...
\item[] \textit{General manager assistant and Organizer for the technical engineering department}%
...
\begin{description}
		...
		\item 	Egypt 2 nd Testing Research Reactor (ETTR – 2)
		
		 \item  Simulator of nuclearpower plant in el Dabaa’s site Operating program.
